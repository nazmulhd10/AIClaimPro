...
urlpatterns = [
    ...
    path('recheck_existing_claim/', views.recheck_existing_claim, name='recheck_existing_claim'),
    path('ajax/existing-claims/', views.ajax_existing_claims, name='ajax_existing_claims'),
